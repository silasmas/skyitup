...
<div id="aboutPage" class="crumbs-area">
    <div class="container">
        <div class="crumb-content">
            <p class="mb-2"><a href="{{ route('home') }}" class="text-warning">@lang('info.menu_home')</a> &raquo; <a
                    href="{{ route('about') }}" class="text-warning">@lang('info.menu_about')</a> &raquo;
                @lang('info.home.team_title')</p>
        ...
        <div class="col-lg-9">
            <div id="member" class="about-area pt--50 pb--30">
                <div class="container">
                    <div class="row">
                        <div class="col-12">
                            <img src="{{ asset($member->picture) }}" alt="{{ $member->names }}"
                                class="rounded-block mr-sm-5 mb-4 float-left">
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="section-title mt-0 mb-5">
                                <h2 class="h2-responsive" class="mt-lg-4" style="line-height: 5rem;">
                                    @lang('info.about.experience')</h2>
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-12">
                            ...
                            <p class="mb-3"><i class="fa fa-angle-right green-text-1"
                                    style="font-size: 3rem; vertical-align: -3px;"></i> {{ $diploma->diploma }}</p>
                            @endforeach
                        </div>
                    </div>
                </div>
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-12">
                            <div class="section-title mt-0 mb-5">
                                <h2 class="h2-responsive" class="mt-lg-4" style="line-height: 5rem;">
                                    @lang('info.about.expertise')</h2>
                                <div class="mt-4" style="border-bottom: 5px solid #d83c2a;"></div>
                            </div>
                            @foreach ($member->expertises as $exp)
                            <p class="mb-3"><i class="fa fa-angle-right red-text"
                                    style="font-size: 3rem; vertical-align: -3px;"></i> {{ $exp->expertise }}</p>
                            @endforeach
                        </div>
                    </div>
                </div>
            ...
            <div id="member" class="about-area pb--50">
                <div class="container">
                    <div class="row">
                        <div class="col-12">
                            <div class="section-title mt-0 mb-5">
                                <h2 class="h2-responsive" style="line-height: 5rem;">@lang('info.about.work_countries')
                                </h2>
                                <div class="mt-4" style="border-bottom: 5px solid #155459;"></div>
                            </div>
                ...
                <div class="widget widget-course" style="background-color: transparent;">
                    ...
                    <div class="course-list">
                        ...
                        <div class="w-cs-single mb-5">
                            ...
                            <div class="fix">
                                <p><a href="{{ route('team.member', ['member_id' => $other_members->id]) }}">{{
                                        $other_members->names }}</a></p>
                                <p class="text-truncate small">{{ $other_members->role }}</p>
                                <small class="text-truncate"><a
                                        href="{{ route('team.member', ['member_id' => $other_members->id]) }}"
                                        class="btn pl-0 py-3 border-bottom border-warning">@lang('info.details')</a></small>
                            </div>
                        </div>
                        @endif
                        @endforeach
                    ...
                    <a href="{{ route('about') }}"
                        class="btn btn-primary btn-round btn-block my-4">@lang('info.menu_about')</a>
                </div>
                <!-- widget course end -->
            </div>
            <!-- sidebar end -->
