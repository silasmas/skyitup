...
<body class="antialiased">
                        ...
                        <div class="ht-social">
                            <ul>
                                ...
                                <li>
                                    ...
                                    <a href="{{ route('change_language', ['locale' => $available_locale]) }}"
                                        title="{{ $locale_name }}">
                        ...
                        <div class="col-xl-3 col-lg-4 col-sm-9">
                            <div class="logo">
                                <a href="{{ route('home') }}" class="d-sm-inline d-inline-block mr-5">
                                    ...
                                    <p class="d-inline-block m-0 text-uppercase"><span
                                            class="green-text-1">Sky</span><span class="red-text">IT</span><span
                                            class="yellow-text-2">Up</span></p>
                                </a>
                                ...
                                <nav>
                                    <ul id="m_menu_active">
                                        <li class="{{ Route::current()->getName() == 'home' ? 'active' : '' }}"><a
                                                href="{{ route('home') }}">@lang('info.menu_home')</a></li>
                                        <li class="{{ Route::current()->getName() == 'about' ? 'active' : '' }}"><a
                                                href="{{ route('about') }}">@lang('info.menu_about')</a></li>
                                        <li class="{{ Route::current()->getName() == 'service' ? 'active' : '' }}"><a
                                                href="{{ route('service') }}">@lang('info.menu_service')</a></li>
                                        <li class="{{ Route::current()->getName() == 'realization' ? 'active' : '' }}">
                                            <a href="{{ route('realization') }}">@lang('info.menu_realization')</a></li>
                                    </ul>
                                </nav>
                            </div>
                        </div>
                ...
                <div class="row">
                    <div class="col-lg-5 col-sm-6 col-12">
                        <div class="widget widget-company px-3">
                            <div class="logo">
                                <img src="{{ asset('assets/img/logo.png') }}" alt="logo" class="me-2">
                                <p class="d-inline-block m-0 text-uppercase"><span class="green-text-1">Sky</span><span
                                        class="red-text">IT</span><span class="yellow-text-2">Up</span></p>
                            ...
                            <ul class="social">
                                ...
                                <li class="ml-3"><a href="https://www.instagram.com/skyitup_sarl/"><i
                    ...
                    <div class="col-lg-3 col-sm-6 col-12 pl-4">
                        <div class="widget footer-link">
                            <h4 class="fwidget-title mt-sm-0 mt-5 mb-5 pb-3 primary-color">@lang('info.quick_links')
                            </h4>
                            <ul>
                                <li><a href="{{ route('home') }}"><i
                                            class="fa fa-arrow-right"></i>@lang('info.menu_home')</a></li>
                                <li><a href="{{ route('about') }}"><i
                                            class="fa fa-arrow-right"></i>@lang('info.menu_about')</a></li>
                                <li><a href="{{ route('service') }}"><i
                                            class="fa fa-arrow-right"></i>@lang('info.menu_service')</a></li>
                                <li><a href="{{ route('realization') }}"><i
                                            class="fa fa-arrow-right"></i>@lang('info.menu_realization')</a></li>
                            </ul>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-4 col-sm-12 col-12">
                        <div class="widget widget-opening">
                            <h4 class="fwidget-title mt-lg-0 mt-5 mb-5 pb-3 primary-color">
                                @lang('info.newsletter_title')</h4>
                            <p>@lang('info.newsletter_description')</p>
                            <form>
                                <label for="subscribe_newsletter" class="sr-only">@lang('info.email')</label>
                                <input type="email" name="subscribe_newsletter" class="form-control rounded-0 mb-4 py-3"
                                    id="subscribe_newsletter" placeholder="@lang('info.email')">
                                <input type="submit" class="btn btn-danger text-white z-depth-0"
                                    value="@lang('info.send')">
                            </form>
                        </div>
                    </div>
                </div>
                <div class="footer-bottom d-sm-flex justify-content-between">
                    <p>Copyright <i class="fa fa-copyright"></i> {{ date('Y') }} <a href="{{ route('home') }}"
                            class="font-weight-bold">SkyITup</a> - @lang('info.all_right_reserved')</p>
    ...
    <!-- scroll top start -->
    <button id="scrollTop" class="position-fixed d-none btn-warning border-0 rounded-circle"
        style="z-index: 999; bottom: 3rem; right: 3rem; transition: .5s;">
    ...
    <<<<<<< Updated upstream @if (Route::current()->getName() == 'home')
