...
<div class="slider-area owl-carousel has-color">
    <div class="slider_item"
        style="background: url({{ asset('assets/img/sliders/slider-1.png') }}) center/cover no-repeat;">
        <div class="container">
            <div class="row">
                <div class="col-lg-7 col-md-9">
                    <div class="slider-content">
                        <h3>@lang('info.slide1_title')</h3>
                        <h1><span class="primary-color">@lang('info.slide1_subtitle1')</span>
                            @lang('info.slide1_subtitle2')</h1>
    ...
    <div class="slider_item"
        style="background: url({{ asset('assets/img/sliders/slider-2.png') }}) center/cover no-repeat;">
        <div class="container">
            <div class="row">
                <div class="col-lg-7 col-md-9">
                    <div class="slider-content">
                        <h3>@lang('info.slide2_title')</h3>
                        <h1><span class="primary-color">@lang('info.slide2_subtitle1')</span>
                            @lang('info.slide2_subtitle2')</h1>
    ...
    <div class="slider_item"
        style="background: url({{ asset('assets/img/sliders/slider-3.png') }}) center/cover no-repeat;">
        <div class="container">
            <div class="row">
                <div class="col-lg-7 col-md-9">
                    <div class="slider-content">
                        <h3>@lang('info.slide3_title')</h3>
                        <h1><span class="primary-color">@lang('info.slide3_subtitle1')</span>
                            @lang('info.slide3_subtitle2')</h1>
    ...
    <div class="slider_item"
        style="background: url({{ asset('assets/img/sliders/slider-4.png') }}) center/cover no-repeat;">
        <div class="container">
            <div class="row">
                <div class="col-lg-7 col-md-9">
                    <div class="slider-content">
                        <h3>@lang('info.slide4_title')</h3>
                        <h1><span class="primary-color">@lang('info.slide4_subtitle1')</span>
                            @lang('info.slide4_subtitle2')</h1>
    ...
    <div class="slider_item"
        style="background: url({{ asset('assets/img/sliders/slider-5.png') }}) center/cover no-repeat;">
        <div class="container">
            <div class="row">
                <div class="col-lg-7 col-md-9">
                    <div class="slider-content">
                        <h3>@lang('info.slide5_title')</h3>
                        <h1><span class="primary-color">@lang('info.slide5_subtitle1')</span>
                            @lang('info.slide5_subtitle2')</h1>
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-4 col-sm-6 col-12 mx-auto">
                <div class="bg-image">
                    <img src="{{ asset('assets/img/welcomer.jpg') }}" alt="" class="float-left mr-4 mb-4"
                        class="img-fluid" style="border-radius: 3rem;">
                    <div class="mask"></div>
                </div>
            </div>
                ...
                <form action="{{ route('download') }}" class="text-sm-right text-center">
                    <button type="submit" class="btn btn-sm btn-primary px-5 z-depth-0" style="border-radius: 3rem;">
                        <i class="fa fa-file-pdf-o mr-3"
                            style="vertical-align: -3px; font-size: 2.5rem;"></i>@lang('info.home.download_brochure')
                    </button>
                </form>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-lg-4">
                <div class="cnt-info" style="border-top: 5px solid #d83c2a;">
                    <h1 class="h1-responsive d-inline-block px-4 bg-danger m-0"><i
                            class="fa fa-phone mt-2 mb-0 text-white"></i></h1>
            ...
            <div class="col-lg-8">
                <div id="google-map">
                    <iframe
                        src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3978.574722962964!2d15.306261015516387!3d-4.302449239004399!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x1a6a33a4f5f0aee5%3A0x8a0a1535583dd981!2sSkyItUp%20Sarl!5e0!3m2!1sfr!2scd!4v1671452470092!5m2!1sfr!2scd"
                        height="400" style="width: 100%; border:0;" allowfullscreen="" loading="lazy"
            ...
            <div class="col-lg-6 offset-lg-3 text-center">
                ...
                <div class="tst-carousel owl-carousel">
                    <div class="testimonial-content pb--40">
                        <h3>&laquo; Vous devez profiter de la vie. Toujours aimez, les personnespositives penser.
                            &raquo;</h3>
